...
class Brain_Env:
    ...
    def step(self, action):
        ...
        if self.reach_budget():
            ...
            # save_img_path_1 = self.state['path_img'][0].replace('preprocessing/test', 'save_RL_result/before_recons')
            # save_img_path_2 = self.state['path_img'][0].replace('preprocessing/test', 'save_RL_result/after_recons')
            # save_label_path_1 = self.state['path_label'][0].replace('preprocessing/test', 'save_RL_result/before_recons')
            # save_label_path_2 = self.state['path_label'][0].replace('preprocessing/test', 'save_RL_result/after_recons')
            #
            # save_folder_path_1 = Path(self.state['folder_path'][0].replace('preprocessing/test', 'save_RL_result/before_recons'))
            # save_folder_path_2 = Path(self.state['folder_path'][0].replace('preprocessing/test', 'save_RL_result/after_recons'))
