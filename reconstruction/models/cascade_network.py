...
def load_recon_model(args, optim=False):
    ...
    best_loss = checkpoint['best_dev_loss']

    if optim:
        optimizer = torch.optim.Adam(recon_model.parameters(), args.lr, weight_decay=args.weight_decay)
        optimizer.load_state_dict(checkpoint['optimizer'])
        del checkpoint
        return recon_model, start_epoch, optimizer, best_loss
